define(["exports"], function (_exports) {
  ...
  _exports.unsafeCSS = _exports.svg = _exports.supportsAdoptingStyleSheets = _exports.notEqual = _exports.html = _exports.eventOptions = _exports.defaultConverter = _exports.customElement = _exports.css = _exports.UpdatingElement = _exports.TemplateResult = _exports.SVGTemplateResult = _exports.LitElement = _exports.CSSResult = void 0;
  ...
  function (_HTMLElement) {
    ...
    function UpdatingElement() {
      ...
      _this3 = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(UpdatingElement).call(this));
      _this3._updateState = 0;
      _this3._instanceProperties = undefined;
      _this3._updatePromise = microtaskPromise;
      _this3._hasConnectedResolver = undefined;
      /**
       * Map with keys for any properties that have changed since the last
       * update cycle with previous values.
       */

      _this3._changedProperties = new Map();
      /**
       * Map with keys of properties that should be reflected when updated.
       */

      _this3._reflectingProperties = undefined;
              ...
              switch (_context.prev = _context.next) {
                ...
                case 10:
                  ...
                  return new Promise(function (res) {
                    return _this6._hasConnectedResolver = res;
                  });
      ...
      value: function update(_changedProperties) {
        ...
        if (this._reflectingProperties !== undefined && this._reflectingProperties.size > 0) {
          ...
          this._reflectingProperties.forEach(function (v, k) {
            return _this7._propertyToAttribute(k, _this7[k], v);
          });
  ...
  */
  ...
  _exports.CSSResult = CSSResult;

  var unsafeCSS = function unsafeCSS(value) {
    return new CSSResult(String(value), constructionToken);
  };

  _exports.unsafeCSS = unsafeCSS;
